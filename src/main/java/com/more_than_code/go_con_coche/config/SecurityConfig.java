        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .permitAll()
                                .requestMatchers("/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**", "/health","/actuator/**").permitAll()
                                ...
                                .hasRole("RENTER")
                                .requestMatchers(HttpMethod.POST, "/api/owner-profiles", "/api/vehicles", "/api/vehicle-rental-offers")
                                .hasRole("OWNER")
                                .requestMatchers(HttpMethod.PUT, "/api/owner-profiles/**",  "/api/vehicles/**", "/api/vehicle-rental-offers/**")
                                .hasRole("OWNER")
                                .requestMatchers(HttpMethod.DELETE, "/api/owner-profiles/**",  "/api/vehicles/**", "/api/vehicle-rental-offers/**")
                                .hasRole("OWNER")
